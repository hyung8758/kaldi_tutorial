...
# num_jobs_initial and final mean that how many GPU you are going to use for training.              
num_jobs_initial=1  # Number of neural net jobs to run in parallel at the start of training
# Original num_jobs_final was set to 8 but hyungwon changed this parameter to 4 in order to adjust it
# to his computer. 
num_jobs_final=1   # Number of neural net jobs to run in parallel at the end of training
